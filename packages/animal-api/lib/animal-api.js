...
(() => {
	var e = {
			...
			287: (e, t, r) => {
				...
				(a.Axios = i),
					(a.CanceledError = r(528)),
					(a.CancelToken = r(247)),
					(a.isCancel = r(813)),
					(a.VERSION = r(424).version),
					(a.toFormData = r(792)),
					(a.AxiosError = r(936)),
			...
			528: (e, t, r) => {
				...
				r(774).inherits(o, n, { __CANCEL__: !0 }), (e.exports = o);
			},
			813: (e) => {
				"use strict";
				e.exports = function (e) {
					...
					n.forEach(["post", "put", "patch"], function (e) {
						function t(t) {
							return function (r, n, o) {
								return this.request(
									a(o || {}, { method: e, headers: t ? { "Content-Type": "multipart/form-data" } : {}, url: r, data: n })
								);
							};
						}
				...
				(i.transitional = function (e, t, r) {
					...
					return function (r, n, a) {
						...
						return (
							t &&
								!s[n] &&
								((s[n] = !0), console.warn(i(n, " has been deprecated since v" + t + " and will be removed in the near future"))),
							!e || e(r, n, a)
						);
					};
				}),
		...
		const o = {
			getCat: () =>
				t()
					...
					.then((e) => ({ imgSrc: e.data.file, text: "CAT" })),
			getDog: () =>
				t()
					.get("https://random.dog/woof.json")
					.then((e) => ({ imgSrc: e.data.url, text: "DOG" })),
		};
	})(),
		(AnimalApi = n);
})();
